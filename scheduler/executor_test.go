...
func TestHyperliquidExecuteResultJSON_AlreadyFlat(t *testing.T) {
	raw := `{
		"execution": {
			"action": "sell",
			"symbol": "ETH",
	...
	if !result.AlreadyFlat {
		t.Fatal("AlreadyFlat should be true for manual HL UI close path")
	}
}
...
func TestBuildHyperliquidExecuteArgs_CloseFullPosition(t *testing.T) {
	args := buildHyperliquidExecuteArgs("ETH", "sell", 0, 0, 0, 0, "", 0, true, true, hlExecuteSnapshot{})

	if !argsContains(args, "--close-full-position") {
		t.Errorf("expected --close-full-position flag in argv, got %v", args)
	}
	if !argsContains(args, "--close-only") {
		t.Errorf("expected --close-only flag on close leg, got %v", args)
	}
...
func TestBuildHyperliquidExecuteArgs_SizedClose(t *testing.T) {
	args := buildHyperliquidExecuteArgs("ETH", "sell", 0.42, 0, 0, 0, "", 0, false, true, hlExecuteSnapshot{})
...
func TestBuildHyperliquidExecuteArgs_ExtraCancelOIDsFullClose(t *testing.T) {
	args := buildHyperliquidExecuteArgs("ETH", "sell", 0, 0, 0, 0, "", 0, true, true, hlExecuteSnapshot{}, 111, 222, 333)
...
func TestBuildHyperliquidExecuteArgs_ExtraCancelOIDsPartialClose(t *testing.T) {
	...
	// a partial close.
	args := buildHyperliquidExecuteArgs("ETH", "sell", 0.5, 0, 0, 0, "", 0, false, true, hlExecuteSnapshot{})
...
func TestBuildHyperliquidExecuteArgs_OptionalFlags(t *testing.T) {
	t.Run("no optional flags", func(t *testing.T) {
		args := buildHyperliquidExecuteArgs("BTC", "buy", 0.001, 0, 0, 0, "", 0, false, false, hlExecuteSnapshot{})
	...
	t.Run("all optional flags", func(t *testing.T) {
		args := buildHyperliquidExecuteArgs("BTC", "buy", 0.001, 2.5, 12345, 0.0005, "isolated", 5, false, false, hlExecuteSnapshot{})
	...
	t.Run("margin mode without leverage", func(t *testing.T) {
		...
		args := buildHyperliquidExecuteArgs("BTC", "buy", 0.001, 0, 0, 0, "cross", 0, false, false, hlExecuteSnapshot{})
...
func TestBuildHyperliquidExecuteArgs_AccountSnapshotForwarded(t *testing.T) {
	...
	args := buildHyperliquidExecuteArgs("BTC", "buy", 0.001, 0, 0, 0, "isolated", 10, false, false, snap)
...
func TestBuildHyperliquidExecuteArgs_AccountSnapshotOmittedWhenIncomplete(t *testing.T) {
	...
	for _, tc := range cases {
		t.Run(tc.name, func(t *testing.T) {
			args := buildHyperliquidExecuteArgs("BTC", "buy", 0.001, 0, 0, 0, "isolated", 10, false, false, tc.snap)
...
func TestBuildHyperliquidExecuteArgs_AccountSnapshotOmittedWithoutMarginMode(t *testing.T) {
	...
	snap := hlExecuteSnapshot{AccountLeverage: 10, AccountMarginMode: "isolated"}
	args := buildHyperliquidExecuteArgs("BTC", "buy", 0.001, 0, 0, 0, "", 0, false, false, snap)
	for _, prefix := range []string{"--account-leverage=", "--account-margin-mode="} {
		if argsHasPrefix(args, prefix) {
